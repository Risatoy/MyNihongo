...
public class card1_8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_card18, container, false);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        if(clicked == 1){
                            MediaPlayer mp = MediaPlayer.create(getActivity().getApplicationContext(), R.raw.kiui);
                            mp.start();
                        }
                        break;
