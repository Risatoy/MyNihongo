...
public class card1_4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_card14, container, false);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        if(clicked == 1){
                            MediaPlayer mp = MediaPlayer.create(getActivity().getApplicationContext(), R.raw.budou);
                            mp.start();
                        }
                        break;
