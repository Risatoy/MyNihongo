...
public class card2_0 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_card20, container, false);

        ImageView image = (ImageView) rootView.findViewById(R.id.number0);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        if(clicked == 1){
                            MediaPlayer mp = MediaPlayer.create(getActivity().getApplicationContext(), R.raw.number0);
                            mp.start();
                        }
                        break;
        ...
        Toast toast = Toast.makeText(getActivity(), "Touch image to hear the voice!", Toast.LENGTH_SHORT);
